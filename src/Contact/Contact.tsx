		...
		<div className='m-10'>
			...
			<form className='p-10 h-auto w-full md:w-4/5 lg:w-2/3 m-auto bg-white mt-10 rounded-lg shadow-lg flex flex-col lg:flex-row' onSubmit={(e) => {
				...
				<div className='flex flex-col w-full lg:w-5/12'>
					<input
						type="text"
						className='p-3 my-3 border-2 box-border rounded-lg'
						placeholder="Name"
						onChange={(e) => {
					...
					<textarea
						rows={5}
						className='p-3 border my-3 box-border-2 rounded-lg'
				...
				<p className='text-center p-5 w-2/12 self-center'>OR</p>
				<div className='w-full lg:w-5/12'>
					<p className='text-center text-2xl font-bold p-3'>Social Media</p>
					<p className='text-center text-xl p-3'>You can also reach out to me through social media.</p>
