const projects = [
	...
	},
	{
		...
		description: 'My personal portfolio website and personal Blog. Built with Next.js, Typescript and Tailwind CSS.',
	...
	},
	{
		...
		description: 'Material Icons API written in Javascript using Cloudflare Functions.',
	...
	},
	{
		...
		description: 'Detection and classification of different water bodies using Landsat-8 satellite images.',
	...
	},
	{
		...
		description: 'Document collaboration online with real-time editing. Just sign in with your Google account and start collaborating.',
	...
	},
	{
		...
		description: 'An Android app built with kotlin to draw something on a canvas and save them as images.',
		downloadUrl: 'https://play.google.com/store/apps/details?id=com.vs.paint',
