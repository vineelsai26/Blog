...
export default function ChatPage() {
	...
	const normalizeModel = useCallback((m: string): string => {
	...
	const createConversation = useCallback((initial?: {
	...
	const persistActive = useCallback((msgs: ChatMessage[], mdl: string) => {
		if (!activeId) return
		window.localStorage.setItem(
			CONVO_KEY(activeId),
	...
	}, [createConversation, loadConversation, normalizeModel])
