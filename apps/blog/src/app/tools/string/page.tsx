			...
			<div className='site-container surface-stack'>
				<section className='section-heading'>
					...
					<p className='section-copy'>
						Transform a string into multiple encoded or reformatted
						variants at once.
					</p>
				</section>
				...
				<section className='surface-stack'>
					...
					<div className='surface-stack'>
						{Object.entries(formatString).map(([key, value]) => {
							...
							return (
								<div
									className='brutal-card flex flex-col gap-4 p-4'
									key={key}
								>
									<div className='text-2xl font-black tracking-[-0.04em] uppercase'>
										{title}
									</div>
